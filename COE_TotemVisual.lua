...
function COE_Totem:UpdateDynamic()
	...
	if (this.Mode == "Flex") then
		...
		for i = start, COE.MaxTotems[ this.Element ] do
			local button = getglobal( "COETotem" .. this.Element .. i );
			button:ClearAllPoints();
...
function COE_Totem:UpdateTotemButtonHotKey()
	...
	-- replace modifiers
	-- ------------------
	text = string.gsub( text, COEMODIFIER_ALT, COEMODIFIER_ALT_SHORT );
	text = string.gsub( text, COEMODIFIER_CTRL, COEMODIFIER_CTRL_SHORT );
	text = string.gsub( text, COEMODIFIER_SHIFT, COEMODIFIER_SHIFT_SHORT );
	text = string.gsub( text, COEMODIFIER_NUMPAD, COEMODIFIER_NUMPAD_SHORT );
