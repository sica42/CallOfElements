...
COESTR_SHIELDCHARGES = "Your %s shield is down to %d charges!";
...
COE_ConfigTotemNotifications = "Notifications";
...
COE_OptionCtrlClick = "Only move totem on Ctrl-Click";
COE_OptionShield = "Enable shield notification";
COE_OptionShieldIcon = "Show icon";
COE_OptionShieldSound = "";
COE_OptionShieldChargesString = "Shield charges warning";
COE_OptionWeapon = "Enable weapon enchant notification";
COE_OptionWeaponIcon = "Show icon";
COE_OptionWeaponSound = "";
COE_OptionEnableTimerNotifications = "Enable expire/destroyed notifications";
COE_OptionNotifyIconDuration = "Duration (sec)";
COE_OptionNotifyIconSize = "Size";
COE_OptionNotifyIconAlpha = "Transparency";
COE_OptionNotifyIconShow = "Show icon";
COE_OptionNotifyIconHide = "Hide icon";
...
COE_OptionAdvisorIcon = "Show icon";
COE_OptionAdvisorSound = "";
...
COE_OptionFixBar = "Lock totem bar positions";
...
COE_OptionCtrlClick = "When enabled, ctrl-clicking a totem\nwill only move it to the current set\nwithout casting it";
COE_OptionShield = "Displays warning when\nyour shield fades";
COE_OptionWeapon = "Displays warning when\nyour weapon enchant fades";
...
COE_OptionFixBar = "Locks the totem bar position\nto prevent dragging it accidentally";
...
BINDING_NAME_COERECALL = "Cast Totemic Recall";
